...
[ADR index](decisions/README.md) — six accepted records. Start with [ADR-0002](decisions/0002-editing-before-generation.md) (editing before generation) and [ADR-0006](decisions/0006-force-native-charts-and-tables.md) (the defect that must never reach a customer).
